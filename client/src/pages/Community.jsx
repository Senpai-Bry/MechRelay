...
function AIAnswerPanel({ question }) {
  ...
  return (
    <div className="mb-8 rounded overflow-hidden border border-garage-border" style={{ backgroundColor: '#1A2535' }}>
      {/* Header bar */}
      <div
        className="flex items-center justify-between px-5 py-3 border-b border-garage-border"
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <span className="text-xs text-garage-muted font-medium">
            Instant diagnostic from MechRelay AI
          </span>
        </div>
        ...
        {(state === "done" || state === "error") && (
          <button
            onClick={fetchAnswer}
            className="text-xs text-garage-muted hover:text-garage-gold transition font-condensed tracking-wider"
          >
            ↺ RETRY
          </button>
        )}
        ...
        return (
          <p
            ...
            className={`text-sm leading-relaxed ${
              isStep
                ? "text-garage-text font-medium"
                : i === 0
                ? "text-garage-text font-semibold"
                : "text-garage-muted"
            }`}
            ...
            >
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <span
                    className="text-xs font-condensed tracking-wider"
